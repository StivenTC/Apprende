...
export const CompareCake = ({ goView, saveUser, userData }) => {
  ...
  const Fraction = () => {
    return <svg width="145" height="145" viewBox="0 0 145 145" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g opacity="0.8">
        <path d="M69.4055 0.0634617C50.7275 0.847883 33.876 8.69921 21.4561 21.0129L52.7159 52.273C57.1246 47.9602 62.938 45.0768 69.4055 44.3733V0.0634617Z" />
        <path d="M69.4055 100.624C62.938 99.9206 57.1246 97.0372 52.7159 92.7244L21.4561 123.984C33.876 136.298 50.727 144.15 69.4055 144.934V100.624Z" />
        <path d="M72.9421 144.997V100.788C79.4221 100.689 85.3732 98.4111 90.0966 94.655L121.435 125.993C108.639 137.705 91.6287 144.886 72.9421 144.997Z" />
        <path d="M72.9421 44.2095V0C91.6287 0.111598 108.639 7.29291 121.435 19.0042L90.0966 50.3424C85.3732 46.5863 79.4221 44.3088 72.9421 44.2095Z" />
        <path d="M123.986 123.542C136.976 110.44 145 92.4067 145 72.4987H100.793C100.793 80.1992 97.7163 87.181 92.7257 92.2826L123.986 123.542Z" />
        <path d="M0 72.4987C0 91.3591 7.20182 108.537 19.0053 121.434L50.3437 90.0953C46.5023 85.2649 44.2073 79.1499 44.2073 72.4987H0Z" />
        <path d="M100.574 68.9621C99.7894 62.6719 96.9401 57.0229 92.7257 52.7149L123.986 21.4548C136.202 33.7765 144.027 50.46 144.915 68.9621H100.574Z" />
        <path d="M19.0053 23.5637L50.3437 54.9021C47.1939 58.8626 45.0841 63.6868 44.4262 68.9621H0.0846156C0.923432 51.4953 7.9435 35.6493 19.0053 23.5637Z" />
