...
export const Exploration2 = ({ goView, userData }) => {
  ...
  const Vector4 = () => {
    return <svg width="85" height="85" viewBox="0 0 85 85" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path className={`${!userData.circle4[0] ? "colorete" : ""}`} d="M43.1846 59.8515C47.1305 59.6584 50.9109 58.1407 53.8911 55.5469L71.4685 73.1243C63.7973 80.3815 53.7531 84.493 43.1846 84.6862V59.8515Z" fill="#27DCAD" />
      <path className={`${!userData.circle4[1] ? "colorete" : ""}`} d="M41.8047 84.7137C31.2086 84.5758 21.1367 80.5195 13.3828 73.2622L30.9602 55.6848C33.9956 58.2787 37.8035 59.7411 41.7771 59.8791V84.7137H41.8047Z" fill="#27DCAD" />
      <path className={`${!userData.circle4[2] ? "colorete" : ""}`} d="M12.3895 72.2964C4.80111 64.6804 0.41366 54.6086 0.0273438 43.8745H24.9172C25.2759 47.986 27.0695 51.8216 29.9669 54.7466L12.3895 72.2964Z" fill="#27DCAD" />
      <path className={`${!userData.circle4[3] ? "colorete" : ""}`} d="M0 42.4948C0 42.4396 0 42.412 0 42.3568C0 31.4572 4.11151 21.137 11.5895 13.2451L29.1669 30.8225C26.3799 34.0234 24.8346 38.1073 24.8346 42.3568C24.8346 42.412 24.8346 42.4396 24.8346 42.4948H0Z" fill="#27DCAD" />
      <path className={`${!userData.circle4[4] ? "colorete" : ""}`} d="M12.5547 12.2518C20.3914 4.47023 30.7668 0.13797 41.8044 0V24.8346C37.3893 24.9726 33.2502 26.7386 30.1045 29.8016L12.5547 12.2518Z" fill="#27DCAD" />
      <path className={`${!userData.circle4[5] ? "colorete" : ""}`} d="M54.7465 29.9671C51.6559 26.8766 47.572 25.0554 43.1846 24.8622V0C54.1946 0.220752 64.5148 4.6082 72.2963 12.3897L54.7465 29.9671Z" fill="#27DCAD" />
      <path className={`${!userData.circle4[6] ? "colorete" : ""}`} d="M59.8789 42.495C59.8789 42.4398 59.8789 42.4122 59.8789 42.357C59.8789 38.1903 58.3888 34.1616 55.6846 30.9883L73.262 13.4109C80.6572 21.2752 84.7135 31.5678 84.7135 42.3846C84.7135 42.4398 84.7135 42.4674 84.7135 42.5226H59.8789V42.495Z" fill="#27DCAD" />
      <path className={`${!userData.circle4[7] ? "colorete" : ""}`} d="M54.8848 54.6086C57.727 51.7112 59.4654 47.9308 59.7965 43.8745H84.6863C84.3 54.5534 79.9677 64.57 72.4622 72.1584L54.8848 54.6086Z" fill="#27DCAD" />
    </svg>
        ...
        <div className="exploration2-content conclusion">
          <div className="exploration2-text">
            ...
            <svg width="165" height="167" viewBox="0 0 165 167" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M137.808 138.614C140.399 135.973 141.983 132.526 142.285 128.829H164.975C164.623 138.564 160.673 147.695 153.831 154.612L137.808 138.614Z" fill="#27DCAD" />
              <path d="M127.142 143.393C130.739 143.217 134.185 141.834 136.902 139.469L152.925 155.493C145.932 162.109 136.776 165.857 127.142 166.033V143.393Z" fill="#27DCAD" />
              <path d="M125.884 166.058C116.225 165.932 107.043 162.234 99.9746 155.619L115.998 139.595C118.765 141.96 122.237 143.293 125.859 143.419V166.058H125.884Z" fill="#27DCAD" />
              <path d="M99.0692 154.738C92.1516 147.795 88.152 138.614 87.7998 128.829H110.489C110.816 132.577 112.452 136.073 115.093 138.74L99.0692 154.738Z" fill="#27DCAD" />
