...
export const Exploration2 = ({ goView, userData }) => {
  ...
  const Vector3 = () => {
    return <svg width="87" height="87" viewBox="0 0 87 87" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path id="0" className={`${!userData.circle3[3] ? "colorete" : ""}`} d="M86.9869 43.4999C86.9869 35.8663 84.9775 28.3672 81.1607 21.7564C77.3439 15.1455 71.8542 9.65583 65.2434 5.83905L43.4999 43.4999L86.9869 43.4999Z" fill="#FFBC0F" stroke="#F7FAFF" strokeWidth="4" mask="url(#path-1-inside-1)" />
      <path id="1" className={`${!userData.circle3[4] ? "colorete" : ""}`} d="M21.7566 5.83896C15.1457 9.65574 9.65602 15.1454 5.83924 21.7563C2.02246 28.3672 0.0130864 35.8662 0.0130825 43.4998L43.5001 43.4998L21.7566 5.83896Z" fill="#FFBC0F" stroke="#F7FAFF" strokeWidth="4" mask="url(#path-2-inside-2)" />
      <path id="2" className={`${!userData.circle3[5] ? "colorete" : ""}`} d="M65.2434 5.83897C58.6326 2.02219 51.1335 0.0128213 43.4999 0.0128161C35.8664 0.0128194 28.3673 2.02219 21.7564 5.83897L43.4999 43.4998L65.2434 5.83897Z" fill="#FFBC0F" stroke="#F7FAFF" strokeWidth="4" mask="url(#path-3-inside-3)" />
      <path id="3" className={`${!userData.circle3[0] ? "colorete" : ""}`} d="M0.0131435 43.4999C0.0131429 51.1334 2.02252 58.6325 5.83929 65.2434C9.65607 71.8542 15.1458 77.3439 21.7566 81.1607L43.5001 43.4999L0.0131435 43.4999Z" fill="#FFBC0F" stroke="#F7FAFF" strokeWidth="4" mask="url(#path-4-inside-4)" />
      <path id="4" className={`${!userData.circle3[1] ? "colorete" : ""}`} d="M65.2434 81.1607C71.8543 77.3439 77.344 71.8542 81.1608 65.2433C84.9775 58.6325 86.9869 51.1334 86.9869 43.4998L43.4999 43.4998L65.2434 81.1607Z" fill="#FFBC0F" stroke="#F7FAFF" strokeWidth="4" mask="url(#path-5-inside-5)" />
      <path id="5" className={`${!userData.circle3[2] ? "colorete" : ""}`} d="M21.7566 81.1607C28.3674 84.9774 35.8665 86.9868 43.5001 86.9868C51.1336 86.9868 58.6327 84.9775 65.2436 81.1607L43.5001 43.4998L21.7566 81.1607Z" fill="#FFBC0F" stroke="#F7FAFF" strokeWidth="4" mask="url(#path-6-inside-6)" />
    </svg>
  }
